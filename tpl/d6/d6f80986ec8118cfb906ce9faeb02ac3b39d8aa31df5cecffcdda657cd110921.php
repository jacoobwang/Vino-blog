...
/* @front/nav.html */
class __TwigTemplate_afa9eb6d1e762cd79086352243907ab74de6ccb51c32a7dc80b4ca930576787c extends Twig_Template
{
    ...
    <nav class=\"am-g am-g-fixed blog-fixed blog-nav\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["cate"]) {
            // line 9
            echo "                <li ";
            if (((isset($context["page"]) ? $context["page"] : null) == $this->getAttribute($context["cate"], "slug", array()))) {
                echo " class=\"am-active\" ";
            }
            echo "><a href=\"";
            echo twig_escape_filter($this->env, (isset($context["DOMAIN"]) ? $context["DOMAIN"] : null), "html", null, true);
        ...
        // line 13
        echo twig_escape_filter($this->env, (isset($context["DOMAIN"]) ? $context["DOMAIN"] : null), "html", null, true);
        echo "admin/home\"><i class=\"am-icon-home admin-link\"></i>Administrator</a>
            </div>
        </div>
    </nav>
</div>
<div style=\"background-color: #261414\">
    ...
    {
        return new Twig_Source("", "@front/nav.html", "D:\\wamp\\www\\blog2\\templates\\frontend\\nav.html");
    }
}
