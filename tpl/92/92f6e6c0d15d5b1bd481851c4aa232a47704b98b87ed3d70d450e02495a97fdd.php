...
/* @admin/user.html */
class __TwigTemplate_92826f56777c2f7355cc3ac402a8c9cc08e90420eaefb93a74826876f9139412 extends Twig_Template
{
...
<div class=\"tpl-content-wrapper\" style=\"background: #f1f1f1;\">
    ...
    <div class=\"\" style=\"margin-left: 20px;padding-top: 20px;\">
        ...
        // line 54
        echo twig_escape_filter($this->env, (isset($context["profile"]) ? $context["profile"] : null), "html", null, true);
        echo "</textarea>
                </div>
        ...
        // line 64
        echo twig_escape_filter($this->env, (isset($context["github"]) ? $context["github"] : null), "html", null, true);
        echo "\"></p>
                    <p><span class=\"am-icon-weibo am-icon-fw blog-icon\"></span>微博<input id=\"weibo\" type=\"text\" value=\"";
        // line 65
        echo twig_escape_filter($this->env, (isset($context["weibo"]) ? $context["weibo"] : null), "html", null, true);
        echo "\"></p>
                </div>
...
<script type=\"text/javascript\">
    ...
    {
        return new Twig_Source("", "@admin/user.html", "D:\\wamp\\www\\blog2\\templates\\backend\\user.html");
    }
}
